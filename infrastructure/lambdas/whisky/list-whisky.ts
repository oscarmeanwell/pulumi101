...
const listWhiskysRole = new aws.iam.Role("lambda-api-listWhiskys_execRole", {
  assumeRolePolicy: aws.iam.assumeRolePolicyForPrincipal({
    Service: ["lambda.amazonaws.com", "apigateway.amazonaws.com"],
  }),
});

const apiWhiskyRolePolicy = new aws.iam.Policy(
...
new aws.iam.PolicyAttachment(
  ...
  {
    policyArn: apiWhiskyRolePolicy.arn,
    roles: [listWhiskysRole],
  },
  { parent: apiWhiskyRolePolicy }
);
